...
public class CorsFilter implements Filter {
    ...
    public void doFilterInternal(HttpServletRequest request,
        ...
        if (!(request.getMethod().equalsIgnoreCase("OPTIONS"))) {
            ...
            response.setHeader("Access-Control-Max-Age", "3600");
            response.setHeader("Access-Control-Allow-Headers", "authorization, content-type,x-auth-token, " + "access-control-request-headers, access-control-request-method, accept, origin, token, authorization, x-requested-with");
